...
//  Chatter
//
//  Created by Lewis Jones on 25/05/2016.
    ...
    store.requestAccessForEntityType(.Contacts, completionHandler: {
        ...
        if granted{
            do{
                ...
                let req = CNContactFetchRequest(keysToFetch: [CNContactGivenNameKey, CNContactFamilyNameKey, CNContactPhoneNumbersKey, CNContactImageDataKey, CNContactImageDataAvailableKey,
